...
Each figure is moved by eight small metal-gear motors, for a total of 16. The display stage is the lid of a 13 x 10 x 6.5 inch pine box. The metal-clasp wall is the Service Edge / Service Wall; the opposite unclasped edge is the audience-facing hinge edge. When unlatched, the lid pivots forward toward the audience around that hinge edge. An 8 x 10 x 1/4 inch MDF tray sits flat inside the box and holds the motors, ESP32, PCA9685 motor board, terminal block, and secured wiring so the complete mechanism can be removed for service.
